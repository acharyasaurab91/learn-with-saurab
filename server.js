...
<div class="admin-modal-overlay" id="createCategoryModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('createCategoryModal')">x</button>
    </div>
...
<div class="admin-modal-overlay" id="editCategoryModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('editCategoryModal')">x</button>
    </div>
...
<div class="admin-modal-overlay" id="createCourseModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('createCourseModal')">x</button>
    </div>
    <form action="/admin/courses" method="POST" enctype="multipart/form-data">
      ...
      <div class="admin-form-group">
        ...
        <div class="admin-form-hint">JPG/PNG/WebP, max 5MB. Recommended: 1280x720</div>
      </div>
      <div class="admin-form-actions">
...
<div class="admin-modal-overlay" id="editCourseModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('editCourseModal')">x</button>
    </div>
...
<div class="admin-modal-overlay" id="addModuleModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('addModuleModal')">x</button>
    </div>
...
<div class="admin-modal-overlay" id="editModuleModal">
  <div class="admin-modal">
    <div class="admin-modal-header">
      ...
      <button class="admin-modal-close" onclick="closeModal('editModuleModal')">x</button>
    </div>
